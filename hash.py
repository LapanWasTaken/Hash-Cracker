...
"""
__Author__ = LapanWasTaken
__Name__ = hasher
__version__ = 3.0.1 (alpha)
__Code__ = python
__Github__ = https://github.com/LapanWasTaken
__Date__ = 13 - 10 - 2021
__Team__ = 4 EXPLOITATION
__License__ = GNU General Public License V.3
(c) LapanWasTaken 2021
"""
...
def banner():
	...
	print (W+'  ------------------------------------------')
	print (P+'      __  __           __              ')
	print (P+'     / / / /___ ______/ /_  ___  _____ ')
	print (P+'    / /_/ / __ `/ ___/ __ \/ _ \/ ___/')
	print (P+'   / __  / /_/ (__  ) / / /  __/ /     ')
	print (P+'  /_/ /_/\__,_/____/_/ /_/\___/_/ .:Created by LapanWasTaken:.  ')
	print (W+'  ------------------------------------------')
	print (Y+"\n 0{======================"+W+" INFO "+Y+"==========================}0")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Name        "+C+":"+W+" Hasher"+Y+"                               |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Code        "+C+":"+W+" python"+Y+"                               |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Version     "+C+":"+W+" 3.0.1 (alpha)"+Y+"                        |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Author      "+C+":"+W+" LapanWasTaken"+Y+"                        |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Quote       "+C+":"+W+" Two Are Better Than One"+Y+"              |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Telegram    "+C+":"+W+" t.me/Cendawann"+Y+"                       |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Github      "+C+":"+W+" https://github.com/LapanWasTaken"+Y+"     |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Date        "+C+":"+W+" 13 - 10 - 2021"+Y+"                       |")
	print (Y+" 0{======================================================}0\n")
...
def info():
	...
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Author   "+C+":"+W+" LapanWasTaken"+Y+"                        |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Quote    "+C+":"+W+" Two Are Better Than One"+Y+"              |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Email    "+C+":"+W+" t.me/Cendawann"+Y+"                       |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Github   "+C+":"+W+" https://github.com/LapanWasTaken"+Y+"     |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Date     "+C+":"+W+" 13 - 10 - 2021"+Y+"                       |")
	print (Y+" 0{===================================================}0\n")
